...
CONFIG = {
    ...
    "output_dir":   "Results/trends_4c",

    # Which feature families to rank/plot over. Any registered families.
    "families":     ["erp", "bp"],          # e.g. ["erp"], ["bp"], ["erp","bp","tf"]
    "feature_opts": {
        "erp": {"feature_set": "recommended"},
